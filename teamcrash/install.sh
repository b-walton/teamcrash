...
echo "=========================="
echo "Installing App teamcrash"

# Here is where we perform installation of scripts, services, etc.
echo " - Installing ROS packages for teamcrash..."
...
runuser -l $LIBPANDA_USER -c /etc/libpanda.d/apps/teamcrash/installRosPackages.sh
...
rosrun robot_upstart install teamcrash/launch/${LAUNCH_FILE} --user root

echo "Enabling can_to_ros startup script"
sudo systemctl daemon-reload
sudo systemctl enable teamcrash
popd
echo "@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@"
